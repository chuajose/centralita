 ...
 * License: MIT
 */angular.module("ui.bootstrap", ["ui.bootstrap.tpls", "ui.bootstrap.collapse", "ui.bootstrap.contextMenu","ui.bootstrap.accordion","ui.bootstrap.alert","ui.bootstrap.buttons","ui.bootstrap.carousel","ui.bootstrap.dateparser","ui.bootstrap.isClass","ui.bootstrap.datepicker","ui.bootstrap.position","ui.bootstrap.datepickerPopup","ui.bootstrap.debounce","ui.bootstrap.dropdown","ui.bootstrap.stackedMap","ui.bootstrap.modal","ui.bootstrap.paging","ui.bootstrap.pager","ui.bootstrap.pagination","ui.bootstrap.tooltip","ui.bootstrap.popover","ui.bootstrap.progressbar","ui.bootstrap.rating","ui.bootstrap.tabs","ui.bootstrap.timepicker","ui.bootstrap.typeahead"]);
 ...
 */
  ...
  .controller('UibTypeaheadController', ['$scope', '$element', '$attrs', '$compile', '$parse', '$q', '$timeout', '$document', '$window', '$rootScope', '$$debounce', '$uibPosition', 'uibTypeaheadParser',
    ...
    var addMore = originalScope.$eval(attrs.typeaheadAddMore) || 0;
      ...
      $q.when(parserResult.source(originalScope, locals)).then(function(matches) {
        ...
        if (onCurrentRequest && hasFocus) {
          if (matches && matches.length > 0) {
            ...
            if(addMore && scope.matches.length ==10){
                scope.matches.push({
                  id: 0,
                  label:" <span class='btn btn-primary waves-effect text-right f-700'>Ver mas</span>",
                  model: inputValue
                });
              }
    ...
    element.on('keydown', function(evt) {
      ...
      switch (evt.which) {
        case 9:
        case 13:
        /* $timeout(function() {  element.parent().submit(); }, 0, false);*/
          scope.$apply(function () {
            if (angular.isNumber(scope.debounceUpdate) || angular.isObject(scope.debounceUpdate)) {
              $$debounce(function() {
...
angular.module("uib/template/datepicker/day.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("uib/template/datepicker/day.html",
    ...
    "          tabindex=\"-1\"><span ng-class=\"::{'c-lightgray': dt.secondary, 'text-info': dt.current}\">{{::dt.label}}</span></button>\n" +
    "      </td>\n" +
    "    </tr>\n" +
    "  </tbody>\n" +
    "</table>\n" +
