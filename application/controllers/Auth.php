...
class Auth extends CI_Controller {
	function __construct()
	{
	 ...
	 private function _template($content)
	{
        $this->load->helper('url');
        $this->load->library('parser');
        $content = str_replace('{BASE_URL}', base_url(),$content);
		$this->parser->parse('web/template.html',array('content' => $content, 'BASE_URL' => base_url(), 'ID_USER' => array()));
	}
	...
	function forgot_password()
	{
		...
		else
		{
			...
			else
			{
				$identity = $this->ion_auth->where('email', strtolower($this->input->post('email')))->users()->row();
	            	...
	            	if(empty($identity)) {
		                ...
		                $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">'.$this->ion_auth->messages()."</div>");
			...
			if ($forgotten)
			{
				...
				$this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">'.$this->ion_auth->messages().'</div>');
