 ...
 */
$config['site_title']                 = "Centralita";       // Site Title, example.com
$config['admin_email']                = "chua.jose@gmail.com"; // Admin Email, admin@example.com
...
/*
 | -------------------------------------------------------------------------
 | Type of Message where register company.
 | -------------------------------------------------------------------------
 */
$config['error_register'][0] = "Cif ya en uso";
$config['error_register'][1] = "Es mi correo y yo no he sido :D";
$config['error_register'][2] = "Otros";
